# Apartment 302 References

Use this folder for future photo/reference boards for the apartment, nursery, and Hollow Saint mood.
This first batch uses direct SVG mockups in `props`, `materials`, and `ui`.
Use `apartment302_import_handoff.md` as the current laptop 2 room-dressing checklist when translating these boards into Unreal.
Use `apartment302_import_manifest.md` when the pass needs stable bundle names, actor labels, and screenshot vocabulary.
